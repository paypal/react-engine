...
function generateReactRouterServerError(type, existingErrorObj, additionalProperties) {
  ...
  if (additionalProperties) {
    _.merge(err, additionalProperties);
  }
...
exports.create = function create(createOptions) {
  ...
  createOptions.docType = _.isString(createOptions.docType) ? createOptions.docType : Config.docType;
  ...
  return function render(thing, options, callback) {
    ...
    }, _.omit(options, createOptions.renderOptionsKeysToFilter));
