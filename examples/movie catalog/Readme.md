...
```shell
  ...
  $ npm install express@4 react-engine@4 react@16 react-dom@16 react-router@3 --save

  # install the rest of the dependencies
  $ npm install babel-register@6 babel-preset-react@6 webpack@1 --save
  ...
  $ touch movies.json
  # copy the contents for this file from http://bit.ly/2BbcpIb
```
...
```shell
  ...
  # public/index.js code for our app can be found here - http://bit.ly/2DLbIIp
```
...
```js
  ...
  const reactRoutesFilePath = path.join(__dirname + '/public/routes.jsx');
...
```shell
  ...
  $ npm install babel-loader@6 json-loader@0.5 --save
...
```shell
  ...
  # copy the contents for this file from http://bit.ly/2mQoU7n
```
